...
namespace NutriCore.src
{
    /// <summary>
    /// Berechnungsklasse.
    /// Hier werden die am ausgewählten Tag verzehrten Lebensmittel gelistet
    /// und deren Makronährstoffe aufgerechnet
    /// </summary>
    internal class TrackingGoalsCalc : INotifyPropertyChanged 
    {
        ...
        /* ersetzt durch Umschreiben der TrackedData Klasse
